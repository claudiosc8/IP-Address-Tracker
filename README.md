...
**Check the report on Frontend Mentor [here](https://www.frontendmentor.io/solutions/ip-address-tracker-using-react-GRIV4e10d)**
...
Your challenge is to build out this IP Address Tracker app and get it looking as close to the design as possible. To get the IP Address locations, you'll be using [IP-API](https://ip-api.com/). To generate the map, we recommend using [LeafletJS](https://leafletjs.com/).
